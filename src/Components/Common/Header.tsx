...
const Header:React.FC = () => {
  ...
  return (
    <header className="flex w-full h-[10vh] bg-[#0f0715] items-center justify-center border-none top-0 sticky z-20 flex-col">
          ...
          <div className="flex w-[50%] justify-between items-center max-sm:w-[133px]">
            <nav className="flex text-[#fff] text-sm justify-between items-center w-[70%] max-sm:hidden">
             ...
             <div>
              ...
              max-sm:hidden max-lg:hidden max-xl:flex shadow-md items-center gap-1 hover:text-[black)] hover:before:translate-x-[105%]
